...
$countmain=$this->db->where('user_id',$logged_in_user->USER_ID)->where('del_status',0)->where('usertype',2)->from("tbl_call")->count_all_results();
$countmaindisable=$this->db->where('user_id',$logged_in_user->USER_ID)->where('counselor_id =',Null)->where('del_status',0)->where('usertype',2)->from("tbl_call")->count_all_results();
        }
...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<form action="telecallerDashboard.html" method="get">
        <div class="row filter-row">
				...
				<div class="card flex-fill">
					<div class="card-body">
						...
						foreach ($data as $key) {
							...
							$countstatus=$this->db->where('user_id',$logged_in_user->USER_ID)->where('status',$key->status_id)->where('del_status',0)->where('usertype',2)->from("tbl_call")->count_all_results();
								 }
