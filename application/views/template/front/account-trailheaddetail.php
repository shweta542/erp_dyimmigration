<?php $arrpre = explode('|',$privileges_settings->trialBalance) ?>
...
<div class="page-wrapper">
	<div class="content container-fluid">
		<div class="page-header">
		 ...
		 <form action="headdetail.html/<?= $headid ?>" method="get">
                            ...
                            foreach ($subheaddata1 as $key => $value) {
    							...
    							<tr tabindex='<?= $w++ ?>' data-trid="<?= $value->journal_id ?>">
    							 ...
    							 <!--  <td><?= ($vendorCustomer1)?$vendorCustomer1->vendorcustomer_name:'' ?>
    							  ...
    							  <td><?= $bal ?></td>
                                  <?php  if(in_array('3', $arrpre) ||  in_array('4', $arrpre)){
    ?>
    								<td class="text-right">
    									<div class="dropdown dropdown-action">
    										<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
    										<div class="dropdown-menu dropdown-menu-right">
<?php if (in_array('3', $arrpre,true)) {
                                                            ?>
