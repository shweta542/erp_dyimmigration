...
<?php $arr = explode('|',$privileges_settings->designation) ?>
  ...
  <div class="page-wrapper">
                <div class="content container-fluid">
                    ...
                    <a href="javascript:void(0)" class="btn add-btn " data-toggle="modal" data-target="#addtags"><i class="fa fa-plus"></i>Add Class</a>
...
$i=1;
                                            ...
                                            <td class="text-right">
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#edittag<?= $key->class_id ?>" href="javascript:void(0)" ><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                           
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_designation<?= $key->class_id ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                ...
                <div class="modal custom-modal fade" id="delete_designation<?= $key->class_id ?>" role="dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="modal-btn delete-action">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="javascript:void(0);" onclick='deleteCommon(" tbl_class","class_id",<?= $key->class_id ?>,"Delete Successfully!")' class="btn btn-primary continue-btn">Delete</a>
                                        </div>
                                        <div class="col-6">
                ...
                <div id="edittag<?= $key->class_id ?>" class="modal custom-modal fade" role="dialog">
                            ...
                            <div class="modal-body">
                             ...
                             <input type="hidden" name="class_id" value="<?= $key->class_id ?>">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="class_name" required="" value="<?= $key->class_name ?>"/>
                                    </div>
