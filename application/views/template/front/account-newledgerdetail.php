	...
	<div class="content container-fluid">
		<div class="page-header">
			<div class="row align-items-center">
				<div class="col">
					<h3 class="page-title">Ledger Summary</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?= ($logged_in_user->STATUS == 1)?'dashboardAdmin.html':'dashboardEmployee.html' ?>">Dashboard</a></li>
						<li class="breadcrumb-item active">Ledger Summary</li>
					</ul>
				</div>
				
			</div>
		</div>
		 <form action="newleadgerdetail.html/<?= $headid ?>" method="get">
         ...
         <div class="review-header balan-hd">
                <div class="row">
                    ...
                    ?>
                            <p><b>Ledger Summary:</b> <span><?= $_GET['from'] ?></span> To <span><?= $_GET['to'] ?></span></p>
                             <?php
                }
                ?>
                        </div>
