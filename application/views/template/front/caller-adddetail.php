...
$lastYear = $firstYear + 50;
        ...
        if($logged_in_user->USER_ID == 1){
			     	...
			     	$this->db->where('c.user_id',$logged_in_user->USER_ID);
			 }
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                <a href="followup.html?type=<?= $usertype ?>" class="btn add-btn" > Followup <?= $count ?></a>
                                <a href="javascript:void(0)" class="btn add-btn mr-2" data-toggle="modal" data-target="#addtags"><i class="fa fa-plus"></i> Add Lead</a>
                               <!--   <a href="javascript:void(0)" class="btn add-btn" data-toggle="modal" data-target="#add_head"><i class="fa fa-plus"></i> Add Lead</a>-->
                                ...
                                <button class="btn btn-white" data-toggle="modal" data-target="#exportdata"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export</button> 
...
<a class="dropdown-item" href="javascript:void(0)"  data-toggle="modal" data-target="#remark<?= $key->call_id ?>"><i class="fa fa-comment m-r-5"></i> Remark</a>
    ...
    ?>
                ...
                <div class="modal custom-modal fade" id="remark<?= $key->call_id ?>" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <!-- <input type="hidden" name="datetime" value="<?= date('Y-m-d H:i:s') ?>">
                                    ...
                                    -->
                                            <div class="submit-section">
                                       <!-- <button type="submit" class="btn btn-primary submit-btn">Submit</button>-->
                                        <!-- <a href="javascript:void(0)" class="btn add-btn" data-toggle="modal" data-target="#addskill"><i class="fa fa-plus"></i> Skilled Category</a>-->
                                           <a href="javascript:void(0)"  class="btn add-btn skillcat" data-toggle="modal" onClick="divFunction(1)"   >Skilled </a>
                                         <!--  data-toggle="modal" data-target="#add_head"-->
                                    </div>
                                    ...
                                    <div class="submit-section">
                                       <!-- <button type="submit" class="btn btn-primary submit-btn">Submit</button>-->
                                        <!-- <a href="javascript:void(0)" class="btn add-btn" data-toggle="modal" data-target="#addskill"><i class="fa fa-plus"></i> Skilled Category</a>-->
                                           <a href="javascript:void(0)" class="btn add-btn studentcat" data-toggle="modal"  onClick="divFunction(2)" >Student </a>
                                   <!-- data-target="#add_head"-->
                                    </div>
                               <!-- </form>-->
                            </div>
                        </div>
                  ...
                  <div id="addskillcattags" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Skilled Category Form</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="addskiiledform" method="POST">
                                   
                             <input type="hidden" name="date" value="<?= date('Y-m-d H:i:s') ?>">
                                    <div class="form-group">
                                        <label>Status Field <span class="text-danger">*</span></label>
                                    
                                       <select class="form-control" name="status" required="" >
                                                    <option value="">Select status</option>
                                                    <option value="ECA">ECA(Educational credentials Assesment)</option>
                                                    <option value="Profile submission">Profile submission</option>
                                                    <option value="Invitation letter (ITA)">Invitation letter (ITA)</option>
                                                    <option value="Case filing">Case filing</option>
                ...
                <div id="add_head" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="addcallerdata" autocomplete="off">
                                    ...
                                    <input type="hidden" name="datetime" value="<?= date('Y-m-d H:i:s') ?>">
                                       <input type="hidden"  id="skillcat_id" name="skillcat_id" value="" >
                                          ...
                                          <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="leadsource" required >
                                                    ...
                                                    <option value="Refernce">Refernce</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input class="form-control " type="number" name="age" min="1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 hidethispte" style="display:none">
                                            <div class="form-group">
                                                <label>Extra Score</label>
                                                <input class="form-control " type="text" name="extra_score"  />
                                            </div>
                                        </div>
                                          <div class="col-sm-6 hidethisduolingo" style="display:none">
                                            <div class="form-group ">
                                                <label>Duolingo</label>
                                                <input class="form-control " type="text" name="duolingo_text"  />
                                            </div>
                                        </div>
                                    </div>
                                   <!-- <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Remark</label>
                                                <textarea class="form-control" type="text" name="remark"   rows="6" cols="50"  /></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                Yes<input class="form-control checkreferral" type="radio" name="previous_referral" value="1"  /><br>
                                                    ...
                                                    <div class="col-md-6">
                                                         No<input class="form-control checkreferral" type="radio" name="previous_referral" value="2" checked/>
                                                    </div>
                                                </div>
                                  ...
                                  <!--  <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>SOP</label>
                                                <input type="file" class="form-control" name="sop" id="" accept=".pdf">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>LOR</label>
                                                <input type="file" class="form-control" name="lor" id="" accept=".pdf">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="fee_receipt" id="" accept=".pdf">
