                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body m-t-15">
                                 <div class="form-validation">
                                    <form  data-url="admin/main/testinsert" data-alert="hi">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body m-t-15">
                                 <div class="form-validation">
                                    <form  data-url="admin/main/newinsert" data-alert="hi" data-location="<?= base_url('admin/main/test')?>" data-loader="true">
