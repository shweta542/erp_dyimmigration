...
$conn = mysqli_connect("localhost","root","","db_erp");
session_start();
            ...
            try {
                ...
                if (res.httpStaus) {
                    ...
                    if (res.data.ErrorCode == "0") {
                        ...
                        var print = res.data.IsoTemplate;
                        if(email != "" &&  print != ""){
                            $.ajax({
                                    url: "https://erp.dyimmigration.com/Api/erpAddFingerprint_request",
                                    type: "post",
    
                                    data: {email:email,print:print},
                                    async:true,
...
alert('Please enter email then capture')
                        }
...
<body>
    <section class="mainbody">
        <div class="container">
            <div class="bio-metric-inr">
            <div class="bio-logo">
				<img src="https://erp.dyimmigration.com/uploads/images/2021-12-30-01/fc52923511a5dfe65a01dcaa57ae89b4.jpeg" width="50" height="50">
			</div>
    <div class="register_panel">
        ...
        <div class="panel-body margin">
            ...
            <div class="row display-flex">
                  <div class="col-md-6 height_100">
                      <div class="capture-lft-sec">
                          <div>
                              <div class="bio-icn">
        							 <img src="images/print.png"> 
        						</div>
        						<div class="bio-capt-frm">
                                  <div class="form-group">
                                      <label for="exampleInputEmail1"> Email address</label>
                                      <input type="email"  id="exampleInputEmail1" name="exampleInputEmail1" placeholder="abc@gmail.com" class="form-control" autocomplete="off" required >
                                  </div>
                                </div>
                              <div class="bio-btn panel-heading font">
                                    <input type="submit" id="btnCapture" value="Capture" class=" btn btn-primary submit-btn" onclick="return Capture()" />
                                    <a href="https://erp.dyimmigration.com/Biometric_match/Biometric_match.php"  class="btn btn-primary submit-btn">Login</a>
                              </div>
                          </div>
                      </div>
                  </div>
                <div class="col-md-6 height_100">
                    <div class="prnt capture-sec">
                        <div>
                            <div class="captured-img">
                                <img id="imgFinger" width="170px" height="200px" Falt="Finger Image" class="padd_top" /> 
                            </div>
                       </div>
                    </div>    
                </div>
        ...
        <div class="row">
             <div class="col-md-5">
                <div class="form-group">
                    <label for="exampleInputPassword1" style="display:none">Password</label>
                   <input pattern="[A-Za-z0-9]+" title="8 characters" placeholder="8 characters" name="exampleInputPassword1" type="hidden" autocomplete="off" 
                   id="exampleInputPassword1" class="form-control" value="6" required />
                 </div>
            </div>
        </div>
          ...
          <div class="row">
             <div class="col-md-5">
                 <div class="form-group">
                    <label for="exampleInputPassword2" style="display:none">Confirm Password</label>
                    <input type="hidden" value="6" class="form-control" autocomplete="off" id="exampleInputPassword2" name="exampleInputPassword2" placeholder="Confirm_Password" required>
                 </div>
            </div>
          </div>  
                    ...
                    <div class="panel">
                        ...
                        <button type="submit" style="display:none" class="btn btn-primary submit-btn" value="submit" onclick=" return validateform()" name="submit" id="sub">Submit</button>
